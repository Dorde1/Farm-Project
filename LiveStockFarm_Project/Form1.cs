...
namespace LiveStockFarm_Project
{
    public partial class Form1 : Form
    {
        ...
        public void fillHashTables()
        {
            try
            {
                OleDbConnection con = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Farm.mdb");//Connection string
                ...
                cmd1.CommandText = "SELECT * FROM Cows"; cmd2.CommandText = "SELECT * FROM Goats";//these are the 4 commands for 4 tables
                cmd3.CommandText = "SELECT * FROM Sheep"; cmd4.CommandText = "SELECT * FROM Dogs";
                cmd1.ExecuteNonQuery(); cmd2.ExecuteNonQuery(); cmd3.ExecuteNonQuery(); cmd4.ExecuteNonQuery();//execute all commands
                DataTable dt1 = new DataTable(); DataTable dt2 = new DataTable(); //create 4 data tables for our four access database tables o
                DataTable dt3 = new DataTable(); DataTable dt4 = new DataTable();
                //create 4 data adapters and adapt data from each of the 4 commands
                OleDbDataAdapter da1 = new OleDbDataAdapter(cmd1); OleDbDataAdapter da2 = new OleDbDataAdapter(cmd2);
                OleDbDataAdapter da3 = new OleDbDataAdapter(cmd3); OleDbDataAdapter da4 = new OleDbDataAdapter(cmd4);
        ...
        {
            OleDbConnection conn = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Farm.mdb");
